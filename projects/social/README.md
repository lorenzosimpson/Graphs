...
1. To create 100 users with an average of 10 friends each, how many times would you need to call `add_friendship()`? Why?
    ...
    add_friendships() would need to be called 500 times. 
    This is because we have 100 users, with 10 friends each on average. 
    This is 100 * 10 = 1000
    However, a friendship is mutual by definition. So if person_a is friends with person_b, we don't need there to be a separate friendship for person_b and person_a. 
    Therefore, we divide 1000 / 2 = 500
